...
export const FORUM_CATEGORIES = [
  ...
  {
    id: 'mercado',
    title: 'Mercado do Adepto & Colecionismo',
    desc: 'Trocas e vendas entre associados: cachecóis clássicos, camisolas de época, crachás e material histórico.',
    icon: 'ShoppingBag',
    topicsCount: 6,
    postsCount: 38,
    lastPost: {
...
export const INITIAL_FORUM_POSTS = [
  {
    ...
    replies: [
      ...
      },
      {
        id: 'rep-2',
        author: 'Nuno Arcos',
        text: 'Bateria afinada a 100%. Esta segunda-feira o estádio vai tremer!',
        time: 'Há 3 min',
      },
    ],
  },
  {
    ...
    timeAgo: 'Há 4 horas',
    title: '🥁 Ensaio de novos ritmos de cânticos na Sede (Sábado às 17h)',
    content: 'Convocatória para todos os elementos da bateria e associados que queiram aprender a tocar os novos ritmos para a época 2026/2027. Apareçam na sede!',
    upvotes: 31,
    hasUpvoted: false,
    commentsCount: 7,
    tag: 'BANCADA',
  ...
  },
  {
    ...
    timeAgo: 'Há 1 hora',
    title: '🚌 Autocarro para Alverca (7.ª Jornada · 19 Setembro) - Inscrições Abertas',
    content: 'A caravana do Grupo 39 ruma ao Ribatejo no sábado 19 de Setembro! Saída do Cais da Alfândega às 11h30. O pack inclui autocarro ida/volta + bilhete no setor visitante por apenas 15,00 €. Reserva imediata com MB WAY!',
    upvotes: 38,
    hasUpvoted: false,
    commentsCount: 14,
    tag: 'DESLOCAÇÃO',
    ...
    replies: [
      {
        id: 'rep-3',
        author: 'André Poente',
        text: 'Lugar já reservado via MB WAY na app! Excelente organização.',
        time: 'Há 45 min',
      },
    ],
  },
  {
    ...
    timeAgo: 'Há 5 horas',
    title: '📍 Ponto de encontro em Alverca para quem viaja em viatura própria',
    content: 'Para os sócios que vão deslocar-se de carro próprio, o ponto de reunião será junto ao parque exterior às 16h30 para entrarmos todos juntos no setor visitante.',
    upvotes: 19,
    hasUpvoted: false,
    commentsCount: 5,
    tag: 'AVISO',
  ...
  },
  {
    ...
    timeAgo: 'Há 6 horas',
    title: 'A solidez da nossa linha defensiva nos Arcos',
    content: 'O apoio da Bancada Poente faz toda a diferença nos Arcos. Nos últimos 10 jogos em casa a equipa sofreu menos de 0.8 golos por jogo. Vamos manter essa força!',
    upvotes: 24,
    hasUpvoted: false,
    commentsCount: 4,
    tag: 'DEBATE',
  ...
  },
  {
    id: 'post-4',
    categoryId: 'mercado',
    categoryName: 'Mercado do Adepto & Colecionismo',
    author: 'Cláudio G39 Store',
  ...
  },
  {
    ...
    categoryId: 'mercado',
    categoryName: 'Mercado do Adepto & Colecionismo',
    author: 'António Coleções',
    authorBadge: 'Sócio 088',
    avatar: 'https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?auto=format&fit=crop&w=150&q=80',
    timeAgo: 'Ontem',
    title: 'Procuro camisola alternativa da Taça de Portugal 2014 (tamanho L)',
    content: 'Procuro exemplar original da camisola branca comemorativa de 2014 para completar coleção pessoal. Tenho cachecóis históricos do Grupo 39 para troca.',
    upvotes: 16,
    hasUpvoted: false,
    commentsCount: 8,
    tag: 'COLECIONISMO',
